...
public class WhiteDwarfWithNebulaSpawn : OrbitingObjectSpawn
{
    ...
    public override void SpawnObject()
    {
        ...
        GameObject whiteDwarf = Instantiate(Manager.Instance.LoadedPrefabs.WhiteDwarfWithNebula, ObjPosition, Quaternion.identity);
